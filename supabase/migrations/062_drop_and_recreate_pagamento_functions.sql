-- Migration: Drop existing functions and recreate with user_id parameter
-- Problema: Função process_pagamento_total já existe com assinatura diferente
-- Solução: Dropar função existente e recriar com nova assinatura
...
-- Recriar process_pagamento_parcial para consistência
