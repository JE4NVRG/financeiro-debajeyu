-- Forçar drop de TODAS as versões das funções com diferentes assinaturas
-- A constraint permite apenas: 'Aberta', 'Parcial', 'Quitada'
-- Mas as funções estavam usando: 'pago', 'pendente'

-- Dropar TODAS as versões possíveis das funções
DROP FUNCTION IF EXISTS process_pagamento_total() CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_total(UUID) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_total(UUID, BOOLEAN) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_total(UUID, UUID) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_total(UUID, UUID, BOOLEAN) CASCADE;

DROP FUNCTION IF EXISTS process_pagamento_parcial() CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_parcial(UUID) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_parcial(UUID, UUID) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_parcial(UUID, UUID, DECIMAL) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_parcial(UUID, UUID, DECIMAL, TEXT) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_parcial(UUID, NUMERIC) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_parcial(UUID, NUMERIC, BOOLEAN) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_parcial(UUID, NUMERIC, UUID) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_parcial(UUID, NUMERIC, UUID, BOOLEAN) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_parcial(UUID, DECIMAL, UUID, BOOLEAN) CASCADE;
DROP FUNCTION IF EXISTS process_pagamento_parcial(UUID, DECIMAL, TEXT) CASCADE;
